-- =====================================================================================
-- Migration Script 53: Reapply ValidationID 14 replay fix after migration 52
-- =====================================================================================
-- Purpose:
--   - Repair schemas that already applied migration 52 before the JSON_TABLE join
--     order bug was found
--   - Reassert the canonical ValidationID 14 definition using CROSS JOIN JSON_TABLE
-- =====================================================================================
...
SELECT 'Migration 53 complete: ValidationID 14 replay definition reasserted after migration 52.' AS Status;

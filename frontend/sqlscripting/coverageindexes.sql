...
CREATE INDEX idx_species_covering_species ON species (SpeciesID, GenusID, SpeciesCode(25), SpeciesName(64),
                                                      SubspeciesName(64), IDLevel(20), SpeciesAuthority(64),
                                                      SubspeciesAuthority(64), ValidCode(100), FieldFamily(32),
                                                      Description(100), ReferenceID);
CREATE INDEX idx_reference_covering_reference ON reference (ReferenceID, PublicationTitle(64), FullReference(100),
                                                            DateOfPublication, Citation(50));

-- Covering indexes for measurementssummaryview
CREATE INDEX idx_coremeasurements_covering_coremeasurements ON coremeasurements (CoreMeasurementID, CensusID, StemID,
                                                                                 MeasurementDate, MeasuredDBH, DBHUnit,
                                                                                 MeasuredHOM, HOMUnit, IsValidated,
                                                                                 Description(100));
...
CREATE INDEX idx_species_covering_species_taxonomies ON species (SpeciesID, GenusID, SpeciesCode(25), SpeciesName(64),
                                                                 SubspeciesName(64), IDLevel(20), SpeciesAuthority(64),
                                                                 SubspeciesAuthority(64), ValidCode(100),
                                                                 FieldFamily(32));
...
CREATE INDEX idx_coremeasurements_covering_coremeasurements_full ON coremeasurements (CoreMeasurementID,
                                                                                      MeasurementDate, MeasuredDBH,
                                                                                      DBHUnit, MeasuredHOM, HOMUnit,
                                                                                      IsValidated, Description(100));
...
CREATE INDEX idx_species_covering_species_full ON species (SpeciesID, GenusID, SpeciesCode(25), SpeciesName(64),
                                                           SubspeciesName(64), SubspeciesAuthority(64), IDLevel(20));
...
CREATE INDEX idx_quadrats_covering_quadrats_full ON quadrats (QuadratID, PlotID, QuadratName(64), DimensionX,
                                                              DimensionY, Area, QuadratShape(64), DimensionUnits);
...
CREATE INDEX idx_plots_covering_plots_full ON plots (PlotID, PlotName(100), LocationName(100), CountryName(100),
                                                     DimensionX, DimensionY, Area, GlobalX, GlobalY, GlobalZ,
                                                     DimensionUnits, PlotShape(64), PlotDescription(100));
CREATE INDEX idx_subquadrats_covering_subquadrats_full ON subquadrats (SubquadratID, SubquadratName(25), DimensionX,
                                                                       DimensionY, QX, QY, CoordinateUnits);

...
create
    definer = azureroot@`%` procedure forestgeo_testing.UpdateValidationStatus(IN p_PlotID int, IN p_CensusID int, OUT RowsValidated int)
BEGIN
    ...
    -- and match the given PlotID and CensusID (if provided)
    UPDATE forestgeo_testing.coremeasurements cm

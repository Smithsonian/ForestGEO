...
begin
    ...
    LOOP
        ...
        UPDATE forestgeo_bci.coremeasurements SET IsValidated = TRUE WHERE CoreMeasurementID = vCoreMeasurementID;
...
BEGIN
    ...
    DECLARE cur CURSOR FOR SELECT cm1.CoreMeasurementID
                           FROM forestgeo_bci.stems s1
                                    ...
                                    JOIN forestgeo_bci.coremeasurements cm1 ON s1.StemID = cm1.StemID

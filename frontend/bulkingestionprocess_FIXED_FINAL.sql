-- ============================================================
-- FINAL FIXED VERSION: bulkingestionprocess
-- All fixes + proper logging to base tables
-- ============================================================
...
CREATE DEFINER=`azureroot`@`%` PROCEDURE `bulkingestionprocess`(
    IN vFileID varchar(36), 
    IN vBatchID varchar(36)
)
main_proc:
BEGIN
    ...
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
        BEGIN
            ...
            INSERT IGNORE INTO uploadmetrics (
                ...
                vUploadId, vFileID, vBatchID, 'forestgeo_testing',
...
SELECT 'Fixed stored procedure with proper logging deployed' as Status;

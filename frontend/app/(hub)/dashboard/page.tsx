...
import { Box, Card, CardContent, Chip, Divider, List, ListItem, ListItemContent, ListItemDecorator, ListSubheader, Stack, Tooltip, Typography } from "@mui/joy";
...
export default function DashboardPage() {
  ...
  return (
    <Box sx={{ display: 'flex', flexGrow: 1, width: '99%', flexDirection: 'column', marginBottom: 5 }}>
          ...
          <CardContent>
            ...
            <List marker="disc">
              ...
              <ListItem>
                <ListItemContent>
                  <Typography level="body-md">
                    Stem & Plot Details - Use this supporting menu to enter fixed data for your census.
                  </Typography>
                </ListItemContent>
              </ListItem>
              <ListItem nested >

...
export default function DashboardPage() {
  ...
  return (
    <Box sx={{display: 'flex', width: '100%', flexDirection: 'column', marginBottom: 5}}>
      ...
      <br/>
      <Typography level={"title-sm"}>If you observe the sidebar, there are 5 different options you can explore
        within this application.</Typography>
      <Typography level={"title-sm"}>Here is a brief overview of each one, how to use them, and how they all work
        together.</Typography>
      <Typography level={"title-sm"}>Please note that this is a work in progress, so changes will be made

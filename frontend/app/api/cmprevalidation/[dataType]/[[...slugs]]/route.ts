  ...
  try {
    ...
    switch (params.dataType) {
      ...
      case 'species':
        ...
        break;
      case 'quadrats':
        let query = `SELECT 1 FROM ${schema}.${params.dataType} WHERE PlotID = ${plotID} AND CensusID = ${censusID} LIMIT 1`; // Check if the table has any row

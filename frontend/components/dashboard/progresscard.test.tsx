  ...
  describe('Rendering', () => {
    ...
    it('should not render pending chip when all quadrats are populated', () => {
      render(
        <ProgressCard
          totalQuadrats={100}
          populatedQuadrats={100}
          populatedPercent={100}
          unpopulatedQuadrats={[]}
          isLoading={false}
        />
      );
  ...
  describe('Progress Percentage', () => {
    ...
    it('should handle decimal percentages', () => {
      render(
        <ProgressCard
          totalQuadrats={100}
          populatedQuadrats={66}
          populatedPercent={66.67}
          unpopulatedQuadrats={[]}
        />
      );
  ...
  describe('Unpopulated Quadrats Display', () => {
    ...
    it('should not display unpopulated list when count > 10', () => {
      ...
      render(
        <ProgressCard
          totalQuadrats={100}
          populatedQuadrats={85}
          populatedPercent={85}
          unpopulatedQuadrats={manyQuadrats}
        />
      );
    ...
    it('should filter out empty string quadrats', () => {
      render(
        <ProgressCard
          totalQuadrats={100}
          populatedQuadrats={97}
          populatedPercent={97}
          unpopulatedQuadrats={['Q001', '', '  ', 'Q002']}
        />
      );
  ...
  describe('Click Handler', () => {
    it('should render with onViewUnpopulated callback', () => {
      ...
      render(
        <ProgressCard
          {...defaultProps}
          onViewUnpopulated={handleViewUnpopulated}
        />
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle single unpopulated quadrat', () => {
      render(
        <ProgressCard
          totalQuadrats={100}
          populatedQuadrats={99}
          populatedPercent={99}
          unpopulatedQuadrats={['Q001']}
        />
      );

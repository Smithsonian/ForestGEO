...
export const CensusLogo: React.FC<SVGProps<SVGSVGElement> & { size?: string }> = ({
  ...
  <svg viewBox="0 0 15 15" fill="currentColor" height={size} width={size} role="img" {...props}>
    <title>Census</title>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export const PlotLogo: React.FC<SVGProps<SVGSVGElement> & { size?: string }> = ({
  ...
  <svg viewBox="0 0 24 24" fill="currentColor" height={size} width={size} role="img" {...props}>
    <title>Plot</title>

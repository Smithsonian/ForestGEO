          ...
          <TabPanel value="new">
            <Stack spacing={2}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                <Typography level="body-md">These rows did not match an existing measurement in the active census and will be inserted as new measurements if confirmed.</Typography>
                <Button
                  size="sm"

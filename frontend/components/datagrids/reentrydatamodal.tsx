        ...
        <DialogContent>
          {!isConfirmStep ? (
            ...
            <Box className="mt-4" sx={{ display: 'flex', flex: 1, flexDirection: 'column' }}>
              ...
              <Typography level='body-md'>1. <b>Original</b> -- ignore all modifications made to the row.</Typography>
              <Typography level='body-md'>2. <b>First Modification</b> -- proceed with the initial change you made.</Typography>
              <Typography level='body-md' sx={{ marginBottom: 2 }}>3. <b>Second Modification</b> -- the initial change contained a type, proceed with the re-entered version.</Typography>
              <Box sx={{ display: 'flex', flex: 1, width: '100%' }}>
                <DataGrid
                  rows={[
                    { ...row, id: 'starter', label: 'Original' },
                    { ...reEnterData, id: 'original', label: 'First Modification' },
                    { ...localData, id: 'modified', label: 'Second Modification (Re-entry)' },
                  ]}
                  columns={[
                    {
                      field: 'label',
                      ...
                      width: 300,
                      renderCell: (params) => (
                        <Typography level='body-md' sx={{ fontWeight: 'bold' }}>{params.value}</Typography>
                      ),
                    },
                    ...columns.map((col) => ({
                      ...col,
                      ...
                      renderCell: (params: GridRenderCellParams) => (
                        <Box sx={{ whiteSpace: 'normal', wordWrap: 'break-word', width: '100%' }}>
                          {params.value}
                        </Box>
                      ),
                    })),

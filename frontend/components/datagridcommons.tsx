...
export default function DataGridCommons(props: Readonly<DataGridCommonProps>) {
  const {
    ...
    shouldAddRowAfterFetch, setShouldAddRowAfterFetch, currentPlot, currentCensus, locked = false
  } = props;
  ...
  const handleDeleteClick = (id: GridRowId) => () => {
    ...
    if (gridType === 'census') {
      ...
      if (currentCensus && rowToDelete && rowToDelete.censusID === currentCensus.censusID) {

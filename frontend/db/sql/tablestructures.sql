...
(
    ...
    StemPlotX         decimal(12, 6)   null,
    StemPlotY         decimal(12, 6)   null,
...
(
    ...
    GlobalX                decimal(15, 6)                                                      null,
    GlobalY                decimal(15, 6)                                                      null,
    GlobalZ                decimal(15, 6)                                                      null,
    GlobalCoordinatesEPSG  int unsigned                                                        null,
...
(
    ...
    PlotX           decimal(12, 6)                      null,
    PlotY           decimal(12, 6)                      null,
...
(
    ...
    -- Reference-table twin of the marker above: set once, in the same transaction
    -- as the species/attributes/personnel reset, so a second file in the same
    -- session never deletes the rows the first file just wrote (#472).
    reference_replacement_completed_at timestamp                                                                                                  default null  null,

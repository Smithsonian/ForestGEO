...
--   (id 2026-07-29-03-create-arcgis-import-staging), so the deploy applies it to every
...
--
--   lib/arcgis/import-session.ts also creates these tables lazily at runtime with an
--   identical definition. Keep the two in step: a schema created by one must satisfy
--   the other, and CREATE TABLE IF NOT EXISTS will NOT reshape an existing table.
-- =====================================================================================

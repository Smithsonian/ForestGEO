...
describe.skip('POST /api/filehandlers/storageload', () => {
  ...
  it('should return 500 if container client creation fails', async () => {
    ...
    const mockReq = createMockRequest('http://localhost/api/filehandlers/storageload?fileName=testfile.txt&plot=testplot&census=testcensus&user=testuser&formType=testform', formData);

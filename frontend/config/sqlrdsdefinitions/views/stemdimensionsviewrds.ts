...
export const initialStemDimensionsViewRDSRow: StemDimensionsViewRDS = {
  id: 0,
  stemID: 0,
  stemTag: '',
  treeID: 0,
...
export const gridColumnsArraySDVRDS: GridColDef[][] = [
  [
  ...
  [
    { field: 'subquadratOrderPosition', headerName: 'Subquadrat Order Position', headerClassName: 'header', flex: 1, align: 'left' },

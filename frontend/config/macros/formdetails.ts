...
export const TableHeadersByFormType: Record<string, { label: string; }[]> = {
  ...
  "measurements": [{ label: "tag" }, { label: "stemtag" }, { label: "spcode" }, { label: "subquadrat" }, 
  { label: "lx" }, { label: "ly" }, { label: "dbh" }, { label: "dbhUnit" }, { label: "hom" }, { label: "homUnit" }, { label: "date" }, { label: "codes" },],

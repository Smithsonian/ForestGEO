...
either HOM may be missing. Missing DBH or dates, zero or negative intervals, and exempt
statuses on either measurement skip the comparison. Short positive intervals remain eligible.

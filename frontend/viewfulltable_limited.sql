...
SELECT
    ...
    a.Status
FROM
    (SELECT * FROM forestgeo_bci.coremeasurements LIMIT 500) AS sub_cm
...
GROUP BY sub_cm.CoreMeasurementID, p.PlotName, sub_cm.PlotID, f.Family, g.Genus, s.SpeciesName, s.SpeciesCode, ss.SubSpeciesName, ss.SubSpeciesID, q.QuadratName, sub_cm.QuadratID, p.PlotX, p.PlotY, q.QuadratX, q.QuadratY, t.TreeID, t.TreeTag, st.StemID, st.StemTag, sub_cm.CensusID, c.PlotCensusNumber, sub_cm.MeasuredDBH, sub_cm.MeasuredHOM, sub_cm.MeasurementDate, a.Status
